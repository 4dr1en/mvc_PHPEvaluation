...
if(isset($_POST['registration'])){
    ...
    if (!$error) {
        ...
        if($newUserRegistered) $logsManager->pushLog('register', 'register', $id);
    }
}

$PAGE['additionalCSS']= './public/style/register.css';
$PAGE['additionalJS']= './public/script/register.js';
$PAGE['mainSectionHtml']= './view/register_view.php';
